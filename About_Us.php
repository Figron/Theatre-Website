...
<body style="height:1500px; font-family:Ubuntu;">
  ...
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
    ...
    <div class="container" style="margin-top:30px">
      <p>Наш театр відомий нашим високим стандартам, і ми раді принести їх до Інтернету!</p>
      <p>Принцип в нашому театрі перший приходить - перший сідає, тому, будь ласка, прийдіть раніше, якщо ви хочете найкращі місця!</p>
      <h5>Робочі години:</h5>
      <ul class="list-group">
        <li class = "list-group-item">Понеділок 09-18</li>
        <li class = "list-group-item">Вівторок 09-18</li>
        <li class = "list-group-item">Середа 09-18</li>
        <li class = "list-group-item">Четверг 09-18</li>
        <li class = "list-group-item">П'ятниця 09-18</li>
      </ul>
    </div>
    <!-- Signup/Login modal -->
