...
<body style="height:1500px; font-family:Ubuntu;">
  ...
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
    ...
    <div class="container" style="margin-top:30px">
      <h3>На цій сторінці ви можете побачити звіт по виставам на місяць</h3>
      <?php
      ...
      <tr>
        ...
        <th style='text-align:right;' width='5%'>Придбано квитків</th>
        <th style='text-align:right;' width='10%'>Зарезервовано квитків</th>
        <th style='text-align:right;' width='10%'>Всього, грн</th>
      </tr>";

      $query2 = "SELECT Name, Image, Code, Price, Date, Bought FROM spectacles";
      ...
      while($row_dishes = $stmt2->fetch_assoc()){
        ...
        <td>";
        echo rand($row_dishes['Bought'], 50);
        echo "</td>
        <td>";
        echo $row_dishes['Price'] * $row_dishes['Bought'];
        echo"
        </td>
        </tr>";
      }
