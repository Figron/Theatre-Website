...
<body style="height:1500px; font-family:Ubuntu;">
  <div class="jumbotron text-center" style="margin-bottom:0">
    <div class="container">
      <h1> Формування рекомендації через місяць. </h1>
    </div>
  </div>
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
    ...
    <div class="container" style="margin-top:30px">
      <p>На цій сторінці ви можете побачити рекомендації по постановці вистав через місяць</p>
      <h5>Таблиця опису категорій прибутковості вистав:</h5>
      <table class="table table-bordered">
        <thead>
          <tr>
            <th>Категорія прибутковості</th>
            <th>Наповненність залу (середня за місяць)</th>
            <th>Список вистав у категорії</th>
            <th>Рекомендації до постановки</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td>Поставити 5 раз в місяць</td>
          </tr>
          <tr>
            <td>II</td>
            <td>75% - 50%</td>
            ...
            <td>
              <ul>
                <li>Чоловіки на мережі нервового зриву</li>
                <li>Три + кіт</li>
                <li>Вечеря на трьох</li>
              </ul>
            </td>
            <td>Поставити 4 раза в місяць</td>
          </tr>
          <tr>
            <td>III</td>
            <td>50% - 25%</td>
            <td>
              <ul>
                <li>Чоловік на час</li>
                <li>Дура любов</li>
              </ul>
            </td>
            <td>Поставити 2 раза в місяць</td>
          </tr>
          <tr>
            <td>IV</td>
            <td>25% - 0%</td>
            <td>
              <ul>
                <li>Приборкання С'юзен</li>
                <li>Два пінгвіни</li>
              </ul>
            </td>
            <td>Поставити 1 раз в місяць</td>
          </tr>
          <tr>
            <td>V</td>
            <td>0%</td>
